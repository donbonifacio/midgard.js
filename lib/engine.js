(function engine() {
  ...
  exports.endRender = function endRender(context, next) {
      var response = context.response._actual.response;
      response.writeHead(context.httpStatusCode, context.httpHeaders);
      response.write(context.responseData, context.encoding);
      response.end();
  };
